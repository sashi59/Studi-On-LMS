...
export const CourseContextProvider = ({ children }) => {
  ...
  async function fetchCourses() {
    try {
        ...
        console.log("Error in fetchCourses:", error.response?.data?.message || error.message);
    }
}
...
async function fetchCourse(id) {
  try {
      ...
      console.log("Error in fetchCourse:", error.response?.data?.message || error.message);
  }
}
async function fetchMyCourse() {
  try {
      ...
      console.log("Error in fetchMyCourse:", error.response?.data?.message || error.message);
  }
}
